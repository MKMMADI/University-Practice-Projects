...
javac %JAVAFX_ARGS% -sourcepath %PRAC_SRC% -cp %PRAC_BIN%;%PRAC_LIB% -d %PRAC_BIN% %PRAC_SRC%\acsse\csc2b\server\ImgServer.java
IF /I "%ERRORLEVEL%" NEQ "0" (
...
java %JAVAFX_ARGS% -cp %PRAC_BIN%;%PRAC_LIB% acsse.csc2b.server.ImgServer
IF /I "%ERRORLEVEL%" NEQ "0" (
